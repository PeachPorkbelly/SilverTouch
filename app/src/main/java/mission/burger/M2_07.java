...
public class M2_07 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m207);

        ImageView missionOrder1 = (ImageView)findViewById(R.id.bg_m2_07_mission_order_1);
        ImageView missionOrder2 = (ImageView)findViewById(R.id.bg_m2_07_mission_order_2);
        ImageView missionOrder3 = (ImageView)findViewById(R.id.bg_m2_07_mission_order_3);



        exit=(ImageButton) findViewById(R.id.bg2_x7);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.cancel:
                        ...
                        break;
                    case R.id.card2:
                        i = new Intent(getApplicationContext(), M2_08.class);
                        startActivity(i);
                        overridePendingTransition(0, 0); //애니메이션 없애기
                        break;
                    case R.id.mobile:
