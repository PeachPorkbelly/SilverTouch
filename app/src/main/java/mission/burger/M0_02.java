...
public class M0_02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView missionOrder1 = (ImageView)findViewById(R.id.bg_m0_02_mission_order_1);
        ImageView missionOrder2 = (ImageView)findViewById(R.id.bg_m0_02_mission_order_2);
        ImageView missionOrder3 = (ImageView)findViewById(R.id.bg_m0_02_mission_order_3);



        exit=(ImageButton) findViewById(R.id.bg0_x2);
