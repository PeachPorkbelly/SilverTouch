...
public class M0_Map extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        burger = (ImageButton)findViewById(R.id.bg_m0_burger);
        theater = (ImageButton)findViewById(R.id.bg_m0_theater);
        hospital = (ImageButton)findViewById(R.id.bg_m0_hospital);
        ktx = (ImageButton)findViewById(R.id.bg_m0_ktx);
        ...
        burger.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(getApplicationContext(), M0_00.class);
